    ...
    func settingsPickers(context: ProviderSettingsContext) -> [ProviderSettingsPickerDescriptor] {
        ...
        let cookieSubtitle: () -> String? = {
            ProviderCookieSourceUI.subtitle(
                ...
                keychainDisabled: context.settings.debugDisableKeychainAccess,
                auto: L10n.string("Automatic imports browser cookies from opencode.ai."),
                manual: L10n.string("Paste a Cookie header captured from the billing page."),
                off: L10n.string("OpenCode Go cookies are disabled."))
        }
        ...
        return [
            ProviderSettingsPickerDescriptor(
                ...
                subtitle: L10n.string("Automatic imports browser cookies from opencode.ai."),
    ...
    func settingsFields(context: ProviderSettingsContext) -> [ProviderSettingsFieldDescriptor] {
        [
            ProviderSettingsFieldDescriptor(
                ...
                title: L10n.string("Workspace ID"),
                subtitle: L10n.string("Optional override if workspace lookup fails."),
                kind: .plain,
                placeholder: "wrk_…",
