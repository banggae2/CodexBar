...
extension SettingsStore {
    var menuObservationToken: Int {
        ...
        _ = self.loginNotificationsEnabled
        _ = self.augmentSessionExpiredNotificationsEnabled
        _ = self.sessionQuotaNotificationsEnabled
        _ = self.sessionQuotaThresholdNotificationsEnabled
        _ = self.sessionQuotaUsageThresholds
        _ = self.weeklyLimitThresholdNotificationsEnabled
